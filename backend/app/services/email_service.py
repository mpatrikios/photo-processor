...
class EmailService:
    ...
    def format_feedback_email(self, feedback_data: dict) -> tuple[str, str]:
        ...
        type_info = {
            ...
            'suggestion': {'emoji': '💡', 'color': '#f59e0b', 'label': 'Feature Suggestion'},
            'improvement': {'emoji': '⚡', 'color': '#10b981', 'label': 'Improvement Idea'},
            'general': {'emoji': '💬', 'color': '#3b82f6', 'label': 'General Feedback'}
        }
        ...
        <body>
            <div class="header">
                <h1>{info['emoji']} Race Photo Processor Feedback</h1>
                <p>New feedback submission received</p>
            </div>
            
            <div class="content">
                <div class="type-badge">{info['emoji']} {info['label']}</div>
        ...
        if feedback_data.get('system_info'):
            body += f"""
                <div class="field">
                    <span class="label">🖥️ System Information:</span>
        ...
        body += f"""
            ...
            <div class="footer">
                <p>This email was automatically generated by the Race Photo Processor feedback system.</p>
